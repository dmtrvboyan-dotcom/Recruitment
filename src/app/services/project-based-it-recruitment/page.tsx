...
export const metadata: Metadata = {
  title: "Project-Based IT Recruitment Services | Scalable Tech Hiring",
  description:
    "Flexible project-based IT recruitment services tailored to short-term initiatives, product launches, and specialized tech projects. We connect businesses with qualified professionals who can deliver results on time and fit seamlessly into your team.",
}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
            ...
            <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4 lg:gap-6 mb-10 lg:mb-16">
              ...
              <p className="text-brand-navy/45 text-sm lg:text-[15px] max-w-sm leading-relaxed">
                We help companies hire contract IT professionals, freelance specialists, and project-based tech talent who can contribute immediately without long-term hiring commitments.
              </p>
            </div>
