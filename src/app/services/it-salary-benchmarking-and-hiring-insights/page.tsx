...
export const metadata: Metadata = {
  title: "IT Salary Benchmarking & Hiring Insights | Market Data",
  description:
    "Make smarter hiring decisions with IT salary benchmarking and recruitment insights. Access up-to-date market data, compensation trends, and talent intelligence to attract and retain top tech professionals.",
}
