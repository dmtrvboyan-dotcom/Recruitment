...
export const metadata: Metadata = {
  title: "Executive Search & Headhunting | Leadership Talent Recruitment",
  description:
    "Targeted executive search and headhunting services for hiring senior technology leaders and high-impact professionals. We help companies secure top-tier talent for critical leadership roles that drive long-term growth.",
}
