    ...
    <section className="relative w-full bg-brand-navy overflow-hidden py-20 lg:py-32">
      ...
      <div className="relative max-w-5xl mx-auto px-5 sm:px-10 xl:px-16 flex flex-col items-center text-center gap-8">
        ...
        <div>
          ...
          <h2 className="text-[clamp(2.8rem,8vw,7rem)] font-bold leading-none tracking-tight uppercase text-brand-white mb-6">
            Ready to
            <br />
            <span className="text-brand-coral">Work with us?</span>
          </h2>
          <p className="text-sm sm:text-lg text-brand-white/55 max-w-lg mx-auto leading-relaxed">
