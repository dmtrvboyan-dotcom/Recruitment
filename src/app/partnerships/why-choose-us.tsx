    ...
    <section className="relative w-full bg-brand-navy overflow-hidden py-20 lg:py-32">
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto px-5 sm:px-10 xl:px-16">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-4">
              {STATS.map((stat, i) => (
                <div
                  key={stat.label}
                  className="flex flex-col items-start gap-1 p-5 rounded-2xl bg-brand-white/2"
                  style={{
                    opacity: visible ? 1 : 0,
          ...
          <div
            className="rounded-3xl bg-brand-white/2 border border-brand-white/8 p-7 sm:p-10 overflow-hidden relative"
            style={{
              opacity: visible ? 1 : 0,
              transform: visible ? "translateY(0)" : "translateY(28px)",
          ...
          >
            ...
            <ul className="space-y-0">
              {REASONS.map((reason, i) => (
                <li
                  key={i}
                  className="flex items-start gap-4 py-4 border-b border-brand-white/6 last:border-b-0 group"
                  style={{
                    opacity: visible ? 1 : 0,
            ...
            <div className="mt-8 pt-6 border-t border-brand-white/6">
              <p className="text-xs sm:text-sm text-brand-white/35 leading-relaxed italic">
