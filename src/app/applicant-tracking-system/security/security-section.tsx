...
export function SecuritySection() {
  return (
    <section className="py-20 md:py-32 px-6  bg-linear-to-b from-white to-[#ededed]">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-3xl mx-auto">
          {securityData.items.map((item, index) => (
            ...
            >
              <div className="w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold shrink-0 border-[1.5px] bg-[#085689] border-[#085689] text-white shadow-[0_4px_12px_rgba(8,86,137,0.3)]">
                {index + 1}
              </div>
