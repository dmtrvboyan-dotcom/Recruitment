...
export const PROCESS_STEPS: ProcessStep[] = [
  ...
  },
  {
    ...
    body: "We schedule and manage the process — nudging candidates, monitoring competing offers, representing your brand honestly, and keeping everything moving so no momentum is lost.",
    icon: CalendarClock,
  },
  {
    id: "close",
