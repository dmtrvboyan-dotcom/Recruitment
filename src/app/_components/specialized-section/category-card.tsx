...
export const CategoryCard = memo(function CategoryCard({
  ...
  return (
    <button
      onClick={onClick}
      className="group relative w-full text-left bg-brand-navy/2 border border-brand-navy/10 hover:border-brand-coral/50 hover:bg-brand-navy/4 rounded-2xl p-5 sm:p-6 lg:p-7 transition-all duration-300 overflow-hidden cursor-pointer"
    >
