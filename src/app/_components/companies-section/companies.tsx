...
export function CompaniesSection() {
  ...
  return (
    ...
    >
      <div
        aria-hidden
        className="absolute -top-32 left-1/2 -translate-x-1/2 lg:left-auto lg:translate-x-0 w-65 h-65 sm:w-90 sm:h-90 lg:w-130 lg:h-130 rounded-full bg-brand-coral/18 blur-[80px] sm:blur-[100px] lg:blur-[120px] pointer-events-none"
      />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
        <div className="max-w-3xl mx-auto text-center mb-10 sm:mb-14 lg:mb-20">
          ...
          <div className="mx-auto h-0.5 w-10 sm:w-16 bg-brand-coral" />
        </div>

        <div className="grid lg:grid-cols-2 gap-4 sm:gap-6 items-stretch max-w-5xl mx-auto">

          <div
            className="relative bg-brand-white/92 backdrop-blur-xl rounded-2xl sm:rounded-3xl border border-brand-white/90 px-6 py-10 sm:px-10 sm:py-12 lg:px-12 lg:py-14 overflow-hidden"
            style={{
              boxShadow:
          ...
          >
            <div
              aria-hidden
              className="absolute top-0 left-8 right-8 h-px bg-brand-white/80 pointer-events-none"
            />
            <div
              aria-hidden
          ...
          >
            <div
              aria-hidden
              className="absolute top-0 inset-x-0 h-px bg-linear-to-r from-transparent via-brand-coral/30 to-transparent pointer-events-none"
            />
