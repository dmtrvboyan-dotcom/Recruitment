...
export const SERVICES: Service[] = [
  {
    ...
    stats: [
      { icon: Award, value: "15+", label: "Years of Experience", sublabel: "in IT recruitment" },
      { icon: Network, value: "2,000+", label: "IT Professionals", sublabel: "in our network" },
  ...
  },
  {
    ...
    stats: [
      { icon: Award, value: "Contract, Freelance & B2B Models", label: "Choose what fits", sublabel: "your project" },
      { icon: Clock, value: "Bulgaria Talent Network", label: "Access skilled professionals across", sublabel: "multiple technologies" },
      { icon: ShieldCheck, value: "Flexible Team Scalling", label: "Scale up or down quickly based on", sublabel: "your needs" },
    ],
  ...
  },
  {
    ...
    stats: [
      { icon: Globe, value: "Many", label: "countries", sublabel: "covered" },
      { icon: ShieldCheck, value: "100%", label: "Local Compliance", sublabel: "guaranteed" },
      { icon: Clock, value: "1-2 wks", label: "Avg. Time to", sublabel: "Onboard" },
    ],
  ...
  },
  {
    ...
    stats: [
      ...
      { icon: ShieldCheck, value: "6+", label: "Compliance Areas", sublabel: "covered" },
      { icon: Globe, value: "100%", label: "Jurisdiction-Specific", sublabel: "guidance" },
    ],
  ...
  },
  {
    ...
    stats: [
      { icon: Globe, value: "30–50%", label: "Lower team cost", sublabel: "vs. Western Europe" },
      { icon: Clock, value: "2–4 wks", label: "Average onboarding", sublabel: "to live team" },
      { icon: ShieldCheck, value: "100%", label: "Legal & payroll", sublabel: "handled for you" },
    ],
